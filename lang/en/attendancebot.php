<?php
// Lang merged by m5desa merge tool. m4desa values override stable on conflicts.
...
$string['error_min_required_minutes'] = 'Debes seleccionar el tiempo mínimo de asistencia';
$string['error_recolection_platform'] = 'ERROR: La platafroma de donde se recoleca la información no puede ser null';
$string['error_required_type'] = 'Debes seleccionar un método de asistencia mínima: porcentaje o minutos';
...
$string['fix_historical_sessions'] = 'Corregir sesiones históricas';
$string['fix_sessions'] = 'Corregir sesiones';
...
$string['form_by_minutes'] = 'Por tiempo';
$string['form_by_percentage'] = 'Por porcentaje';
...
$string['form_min_required_minutes_settings'] = 'Tiempo mínimo (en minutos)';
$string['form_min_required_minutes_text'] = 'minutos de asistencia';
...
$string['form_required_type'] = 'Mínimo tiempo de asistencia';
$string['form_saving_platform'] = 'Seleccione la plataforma donde se va a guardar la informacion';
$string['invalid_date_range'] = 'La fecha de inicio debe ser anterior a la fecha de fin.';
...
$string['missing_dates'] = 'Fechas de inicio y fin son obligatorias.';
$string['modulename'] = 'ORT Attendance Bot Module';
$string['modulenameplural'] = 'ORT Attendance Bots';
$string['no_sessions_to_fix'] = 'No hay sesiones que necesiten corrección.';
...
$string['sessions_fixed_success'] = 'Las sesiones históricas se han corregido correctamente.';
