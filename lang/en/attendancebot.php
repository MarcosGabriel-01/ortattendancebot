...
$string['form_camera_settings'] = 'Detección de cámara';
$string['form_cameradescription_settings'] = 'Marca la casilla para habilitar la detección de cámara';
...
$string['camera'] = 'detección de camara habilitada';
$string['camera_help'] = 'Si la casilla esta marcada, el alumno deberá haber encendido la cámara durante la reunión para ser considerado presente, si esta desmarcada, no tendrá en cuenta la cámara.';
...
//LN CORRECION plugin habilitado
$string['text_instrucciones'] = '
    ...
    <ul>
        <li><strong>Plugin habilitado:</strong> Si la opción esta tildada, el plugin funcionará para el curso donde esta instalado.</li>
        
        <li><strong>Mínimo tiempo de asistencia:</strong> Seleccione "por porcentaje" o "por tiempo" para calcular la asistencia requerida.</li>
        ...
        <li><strong>Tiempo mínimo (en minutos):</strong> Este valor indica el tiempo mínimo en minutos que debe estar presente la persona en la reunion para que se considere presente.</li>
        <li><strong>Tolerancia de llegada tarde:</strong> Este valor, que va de 0 a 60 minutos, indica los minutos que la persona tiene para que no se le considere tarde. Si elige 0 minutos, entonces se desactivará esta opción, y no habrá llegadas tarde.</li>
        ...
        <li><strong>Detección de cámara:</strong> Si la opción esta tildada, el alumno deberá haber encendido la cámara durante la reunión para ser considerado presente.</li>
        <li><strong>Guardar clase grabada:</strong> Si la opción esta tildada, el plugin guardará la grabación de la reunión en el curso.</li>
...
$string['error_camera'] = 'ERROR: El valor no puede ser null';
...
//newLN mejora5 
$string['form_required_type'] = 'Mínimo tiempo de asistencia'; //msje
$string['form_by_percentage'] = 'Por porcentaje'; //select
$string['form_by_minutes'] = 'Por tiempo'; //select
$string['form_min_required_minutes_text'] = 'minutos de asistencia'; //texto next to select
$string['form_min_required_minutes_settings'] = 'Tiempo mínimo (en minutos)'; //msje
$string['error_required_type'] = 'Debes seleccionar un método de asistencia mínima: porcentaje o minutos'; //error tipo
$string['error_min_required_minutes'] = 'Debes seleccionar el tiempo mínimo de asistencia'; //error min
$string['required_type_help'] = 'Controlar presencia en el zoom por porcentaje/minutos';
$string['min_required_minutes_help'] = 'Elija el tiempo minimo de presencia de un estudiante para que se lo considere presente';

// STRINGS DE ACTIVACIÓN DE RESPALDO DE RECORDINGS
$string['form_backuprecordings'] = 'Respaldar Recordings';
$string['form_backuprecordings_desc'] = 'Habilita el respaldo automático de grabaciones Zoom en Moodle y en la máquina local.';
$string['form_backuprecordings_help'] = 'Si está habilitado, las grabaciones de Zoom se respaldarán automáticamente en Moodle y en la máquina local.';
$string['error_backuprecordings'] = 'Error al validar el campo de respaldo.';

// Ptrps strings faltantes
$string['required_type'] = 'Tipo de asistencia mínima';