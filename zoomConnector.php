 ...
 * zoomConnector.php
 *
 * Connects to Zoom API, lists recent recordings, downloads MP4s.
...
// ---- CONFIG ----
$zoom_access_token = 'YOUR_ZOOM_ACCESS_TOKEN'; // OAuth token
...
/**
 * Perform GET request to Zoom API.
 */
...
/**
 * Download a Zoom recording file to disk.
 */
