...
$string['back'] = 'Back';
$string['trigger_backup'] = 'Trigger attendance bot recording backup';
$string['form_delete_source'] = 'Deletes from source';
$string['form_delete_source_desc'] = 'Deletes the video on cloud storage';
$string['form_delete_source_help'] = 'If enabled, Zoom recordings will automatically be deleted up in the cloud storage';